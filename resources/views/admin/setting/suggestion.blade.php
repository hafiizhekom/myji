...
@section('pagetitle', 'Setting Suggestion Product')
@section('content')
    ...
    data-toolbar="#toolbar">
        ...
        <tbody>
            @foreach ($data['setting_suggestion'] as $key=>$value)
                <tr>
                    <td>{{$value->id}}</td>
...
@section('modals')
    ...
    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form class="form" action="{{route('setting.suggestion.add')}}" method="post">
                @csrf
                ...
                <button class="btn btn-primary btn-block" type="submit">Add New Suggestion Item</button>
                </div>
            </form>
        </div>
        </div>
    ...
    <div class="modal fade" id="edit-{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="form" action="{{route('setting.suggestion.edit', $value->id)}}" method="post">
                @csrf
                <div class="modal-header">
    ...
    <div class="modal fade" id="increasing-{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="{{route('setting.suggestion.increasing.edit', $value->id)}}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="decreasing-{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="{{route('setting.suggestion.decreasing.edit', $value->id)}}" method="post">
                    @csrf
                    <div class="btn-group" style="width: 100%;">
    ...
    <div class="modal fade" id="delete-{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="{{route('setting.suggestion.delete', $value->id)}}" method="post">
                    @csrf
                    {{ method_field ('DELETE') }}
                    <div class="btn-group" style="width: 100%;">
